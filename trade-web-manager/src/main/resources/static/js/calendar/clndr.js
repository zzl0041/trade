...
;(function ( $, window, document, undefined ) {
  ...
  // This is where the magic happens. Given a moment object rep/resenting the current month,
  ...
  Clndr.prototype.render = function() {
    ...
    if(this.options.constraints) {
      // in the inte/rest of clarity we're just going to remove all inactive classes and re-apply them each render.
