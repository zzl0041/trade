...
function require(path, parent, orig) {
  ...
  // registered function
  if (!module._/resolving && !module.exports) {
    var mod = {};
    mod.exports = {};
    mod.client = mod.component = true;
    module._/resolving = true;
    module.call(this, mod.exports, require.relative(/resolved), mod);
    delete module._/resolving;
...
/**
 * @p/reserve FastClick: polyfill to remove click delays on browsers with touch UIs.
 *
 * @version 0.6.11
...
function FastClick(layer) {
	...
	if (typeof layer.onclick === 'function') {
		...
		// Android browser on at least 3.2 requi/res a new reference to the function in layer.onclick
...
/**
 * iOS 4 requi/res an exception for select elements.
 *
 * @type boolean
 */
...
/**
 * iOS 6.0(+?) requi/res the target element to be manually derived
 *
 * @type boolean
 */
...
/**
 * Determine whether a given element requi/res a native click.
 *
...
/**
 * Determine whether a given element requi/res a call to focus to simulate click into element.
 *
 * @param {EventTarget|Element} target Target DOM element
 * @returns {boolean} Returns true if the element requi/res a call to focus to simulate native click.
 */
...
FastClick.prototype.findControl = function(labelElement) {
	...
	return labelElement.querySelector('button, input:not([type=hidden]), keygen, meter, output, prog/ress, select, textarea');
};
...
FastClick.prototype.onClick = function(event) {
	...
	// Very odd behaviour on iOS (issue #18): if a submit element is p/resent inside a form and the user hits enter in the iOS simulator or clicks the Go button on the pop-up OS keyboard the a kind of 'fake' click event will be triggered with the submit-type input element as the target.
