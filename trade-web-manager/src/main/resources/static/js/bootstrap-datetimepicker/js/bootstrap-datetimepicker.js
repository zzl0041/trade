...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
		...
		this.component/reset = this.element.is('.date') ? this.element.find('.date-/reset').parent() : false;
	...
	* ================== */
	...
	$(document).on(
		...
		function (e) {
		    ...
		    e.preventDefault();
		    // component click requi/res us to explicitly show it
