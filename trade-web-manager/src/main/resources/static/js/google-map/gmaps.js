...
if(window.google && window.google.maps){
  ...
  var GMaps = (function(global) {
    ...
    GMaps.staticMapURL = function(options){
      ...
      else if (options.add/ress){
        parameters.push('center=' + options.add/ress);
        delete options.add/ress;
      }
      else if (options.lat){
      ...
      if (markers){
        ...
        for (var i=0; data=markers[i]; i++){
          ...
          loc = (data.add/ress ? data.add/ress : data.lat + ',' + data.lng);
